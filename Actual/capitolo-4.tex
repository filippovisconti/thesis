...
Il dispositivo utilizzato per effettuare i test ha una scheda di rete che supporta fino a  1 Gbit/s, ed è collegato ad Internet via fibra ottica, che satura il gigabit a disposizione, in modo tale che la macchina per fare i test non sia il collo di bottiglia dell'ambiente.
...
Con mrt si effettuerà il secondo test, inviando 1000 pacchetti della dimensione di 5000 byte, che comporta una durata del test di oltre 15 minuti.
