...
Encapsulating Security Payload \cite[RFC4303]{RFC4303} (ESP) offre confidenzialità dei fati, autenticazione del mittente, controllo di integrità e protezione da attacchi relay.
